        ...
        <div class="">
            <div>
                <div class="d-flex justify-content-lg-between align-items-lg-baseline border-bottom-primary px-4 pt-3">
                    <p style="font-size: 1.4rem;" class="w3-left text-primary "><b>Uploaded Thesis/Capstone</b></p>
...
<!--     <button style="margin-left: 10px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
        CREATE  
            ...
            <div class="mb-3">
              <label>Thesis/Capstone File (in PDF form)</label>
              <input type="file" name="upload_file" class="text-gray-700 form-control" placeholder="" required >
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="upload_btnA" class="btn btn-primary px-4">Save</button>
                            </div>
                        </form>
        ...
        <div id="view_upload_details_modal" class="modal fade" tabindex="-1" aria-labelledby="view_details_modal_reservation" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-gray-700" id="exampleModalLabel">Thesis and Capstone Archiving System Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <div class="modal-body" id="fetch_upload">
                ...
                <div class="modal-content">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body px-4 w3-center">
                            ...
                            <h4> Are you sure to delete the uploaded Thesis/Capstone?</h4>
